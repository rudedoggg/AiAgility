                                            ...
                                            <div className="w-[80%] p-8 overflow-y-auto border-r border-border/50">
                                                <div className="space-y-4">
                                                    <div className="rounded-lg border bg-card/40">
                                                        <div className="px-4 py-2 border-b text-[11px] uppercase tracking-wider text-muted-foreground" data-testid={`text-attachments-title-${bucket.id}`}>Attachments</div>
